...
<div class="main">
      ...
      <h5>SafeMoney descrizione prodotto:</h5>
      <img src="images/safem2.jpg" alt="safemoney" style="width:100%; float:left"><br>
  ...
  <a href="xpos.php"> <img src="images/xpos.jpg" alt="xpospc" style="width:50%"> Xpospc</a> <br>
      ...
      <p class="desc">
         	SISTEMA SICURO E PRECISO DI CASH HANDLING
			PAGAMENTI VELOCIZZATI GRAZIE AL SISTEMA  DI ACCETTAZIONE SMART COIN SYSTEM (MONETE IN QUANTITA')
			VELOCE RESTITUZIONE BANCONOTE A MAZZETTO FINO A 15 PEZZI
			SPORTELLO FRONTALE CON PIANO ESTRAIBILE PER UNA SEMPLICE MANUTENZIONE
			GESTIONE DEL CASSETTO INTEGRATO IN XPOS PC SOFTWARE
			IDEALE PER I PUNTI VENDITA DI PICCOLA E MEDIA AFFLUENZA
			INTERFACCIAMENTO SEMPLICE E SICURO
      		</p>
