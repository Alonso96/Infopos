...
<html lang="en">
<head>
<title>Assistenza- InfoPos</title>
<meta charset="UTF-8">
...
<div class="main">
  ...
  <a href="defiscalizzazione.php"> Fiscalizzazione </a>
  ...
  <h5>Assistenza</h5>
      <p class="desc">
     INFO POS con suo laboratorio interno ed il personale tecnico specializzato garantisce un'assistenza puntuale hardware e software sia in via telematica sia "sul posto"
</p>
<h5>ASSISTENZA SOFTWARE:</h5>
<p class ="desc">
Tutte le soluzioni pensate per soddisfare le specifiche esigenze dell'azienda, del professionista e del privato. Sistemi software per la vendita al banco e gestione del punto vendita con collegamento di PC a registratore di cassa e lettore di codici a barre. Configurazione e programmazione.
</p>
<h5>ASSISTENZA TECNICA HARDWARE:</h5>
<p class="desc">
Rimozione e sostituzione componenti hardware danneggiati (ricambi originali).
