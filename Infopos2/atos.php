...
<div class="main">
      ...
      <h5>Atos Descrizione Prodotto: </h5>
      <img src="images/atos15.jpg" alt="asso" style="width:50%;float:left"><br>
  ...
  <a href="atos.php"> <img src="images/asso.jpg" alt="atos" style="width:50%"> Atos</a> <br>
    <a href="printf.php"> <img src="images/printf.jpg" alt="atos" style="width:50%"> PrintF</a> <br>
      ...
      <p class="desc">
      Design moderno e raffinato con una linea elegante e slanciata fa di questo prodotto il protagonista dell’ambiente in cui viene posizionato. Estetica e funzionalità per semplificare il processo di incasso. Atos rappresenta una soluzione esclusiva che concretizza la gestione del punto cassa.
      </p>
  	</div>	  
<div style= "clear: both;"> </div>
