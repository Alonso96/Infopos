...
<div class="main">
      ...
      <h5>Pos8000: Descrizione prodotto</h5>
      <img src="images/xpos.jpg" alt="pos8000" style="width:70%;float:left"><br>
      <div style= "clear: both;"> </div>
      <br>
     
      <p class="desc">
         	Il POS8000 è il sistema integrato Ditronetwork, adatto a tutte le postazioni di lavoro di dimensione contenute.
			Design compatto, linee essenziali, il POS8000 è un prodotto tecnologicamente avanzato, che affianca alla potenza di calcolo della CPU ATOM, la nitidezza di risoluzione dello schermo piatto LCD touch screen da 15” e del display cliente, 2x20 caratteri, orientabile sia verticalmente che orizzontalmente.

			Ideale per tutti i software dedicati alla gestione professionale del punto vendita.
