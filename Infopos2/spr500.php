...
<div class="main">
      ...
      <h5> SPR500: Descrizione Prodotto</h5>
      <img src="images/spr500.png" alt="cei Systems" style="width:100%;float:left"><br>
  ...
  <a href="smartnote.php"> <img src="images/t15.png" alt="t15" style="width:50%"> T15</a>
  
  
  </aside>
      <p class="desc">
      La SPR500 è la stampante fiscale più collaudata del catalogo CEI Systems.
È un ottimo strumento per quelle attività che cercano un prodotto dalle grandi prestazioni puntando su una stampante robusta, di lunga durata.
Approvata dall’Agenzia delle Entrate, la stampante fiscale SPR500 grazie ai protocolli ottimizzati dai nostri tecnici è perfettamente interfacciabile con tutti i sistemi e punti cassa CEI.

La stampante fiscale SPR500, con una semplice programmazione, è in grado di stampare messaggi di cortesia e loghi personalizzati su carta termica con stampa ad alta risoluzione.
       </p>
  	</div>	  
<div style= "clear: both;"> </div>
