...
<div class="main">
      ...
      <h5>Asso Descrizione Prodotto: </h5>
      <img src="images/asso.jpg" alt="asso" style="width:50%;float:left"><br>
      <div style= "clear: both;"> </div>
      <br>
      
        <aside>
  <h5 style="color:red;">Prodotti Correlati</h5>
  <a href="atz4.php"> <img src="images/atos15.jpg" alt="atos" style="width:50%"> Atos</a> <br>
      ...
      <p class="desc">
      Asso, soluzione Android compatta con a bordo un Software dalle molteplici potenzialità.
...
Stampante Robusta e con meccanica evoluta, Easy Loading, che prevede:

    Sensore chiusura coperchio cutter-jamming
    Riposizionamento in home della taglierina all’apertura coperchio
      </p>
  	</div>	  
<div style= "clear: both;"> </div>
