...
<div class="main">
      ...
      <h5>Q3X-F Descrizione Prodotto: </h5>
      <img src="images/q3xf.png" alt="cei Systems" style="width:50%;float:left"><br>
  ...
  <a href="smartnote.php"> <img src="images/smartnote.png" alt="tft14" style="width:50%"> App Smartnote </a>
      ...
      <p class="desc">
      Questa stampante fiscale è ideale per chi desidera alte prestazioni senza rinunciare all’importanza di una estetica di forte impatto del prodotto.

Perfettamente compatibile con ogni sistema CEI Systems, la Q3X si caratterizza per la sua alta qualità di stampa dello scontrino, garantita da un’evoluta testina termica, e per la sua efficienza, dovuta anche alla taglierina impiegata nella sua realizzazione.
         </p>
  	</div>	  
<div style= "clear: both;"> </div>
