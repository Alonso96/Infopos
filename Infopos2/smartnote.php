...
<div class="main">
      ...
      <h5> Descrizione: App SmartNote</h5>
      <img src="images/smartnote.png" alt="cei Systems" style="width:50%;float:left"><br>
      <div style= "clear: both;"> </div>
      <br>
      <aside>
  <h5 style="color:red;">Prodotti correlati:</h5>
  <a href="t15.php"> <img src="images/t15.png" alt="t15" style="width:120px"> T15  </a> <br>
  <a href="tft14.php"> <img src="images/tft14.png" alt="tft14" style="width:120px"> TFT14  </a><br>
   <a href="atz4.php"> <img src="images/atz4.png" alt="tft14" style="width:120px"> ATZ4  </a>
  
  </aside>
      
      <p class="desc">
         Descrizione Prodotto
SmartNote è un’App sviluppata da CEI Systems per facilitare la gestione delle comande di ristoranti, bar e tutte le attività del settore Ho.Re.Ca.

Quest’app, compatibile sia su sistemi Android che su dispositivi iOS, è la soluzione ottimale per chi vuole effettuare una spesa iniziale contenuta ma allo stesso tempo desidera un sistema di raccolta comande completo.

Il cameriere sarà in grado di prendere facilmente le ordinazioni dei clienti al tavolo con il suo IPhone o Smartphone oppure tramite IPad o Tablet ed inviarla direttamente in cucina, al bar, e in qualsiasi altro reparto.

SmartNote non necessita di particolari competenze o formazione, infatti grazie al suo design intuitivo qualsiasi cameriere, anche alle prime armi, riuscirà ad averne il pieno controllo dopo pochi minuti di utilizzo.

Collegata direttamente alla cassa CEI tramite Wi-Fi, comunica in tempo reale con i diversi reparti, gestendo tavoli ed ordinazioni.
</p>
