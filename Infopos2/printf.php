...
<div class="main">
      ...
      <h5>PrintF Descrizione Prodotto: </h5>
      <img src="images/printf.jpg" alt="printf" style="width:50%;float:left"><br>
      <div style= "clear: both;"> </div>
      <br>
      
        <aside>
  <h5 style="color:red;">Prodotti Correlati</h5>
  <a href="atos.php"> <img src="images/atos15.jpg" alt="t15" style="width:50%"> Atos </a> <br>
     ...
     <b>Facile da installare</b><br>
Print F si integra facilmente nell’infrastruttura esistente, grazie alle interfacce seriale, USB ed ETHERNET e ai molteplici protocolli di comunicazione
<br>
<b>Facile per il tuo lavoro</b><br>
La velocità del meccanismo di stampa elevata, pari a 300 mm/sec, permette di fornire un servizio più rapido ai tuoi clienti.
<br>
<b>Facile da utilizzare</b><br>
Print F è dotata di una taglierina automatica e grazie al sistema di caricamento “drop-in”, la carta in rotolo si sostituisce in pochi secondi. La velocità del meccanismo di stampa elevata, pari a 300 mm/sec, permette di fornire un servizio più rapido ai tuoi clienti.
      </p>
  	</div>	  
<div style= "clear: both;"> </div>
